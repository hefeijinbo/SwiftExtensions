...
public extension UITabBar {
    ...
    /// - Parameters:
    ///   - background: 背景色
    ///   - selectedBackground: 选中背景色
    ///   - itemColor: 图标tint color
    ///   - selectedItemColor: icon tint color for item.
    @objc func setBackgroundColors(
        _ background: UIColor? = nil,
        ...
        // selectedItem
        tintColor = selectedItemColor ?? tintColor
        // shadowImage = UIImage()
